...
const HangedMan: React.FC<HangedManProps> = ({ errorLength }) => {
	...
	return (
		...
		>
			<path
				style={{ display: getDisplayValue("base") }}
				id="base"
			...
			/>
			<rect
				style={{ display: getDisplayValue("verticalBar") }}
				x="206.5"
				y="0.5"
				width="12"
				height="346"
			...
			/>
			<path
				style={{ display: getDisplayValue("diagonalBar") }}
				id="diagonalBar"
			...
			/>
			<path
				style={{ display: getDisplayValue("noose") }}
				id="noose"
			...
			/>
			<rect
				style={{ display: getDisplayValue("horizontalBar") }}
				id="horizontalBar"
				x="69.5"
				y="12.5"
				width="12"
			...
			/>
			<rect
				style={{ display: getDisplayValue("body") }}
				id="body"
				x="73.5"
				y="116.5"
				width="1"
			...
			/>
			<rect
				style={{ display: getDisplayValue("leg1") }}
				id="leg1"
				x="73.217"
				y="216.676"
				width="1"
			...
			/>
			<rect
				style={{ display: getDisplayValue("leg2") }}
				id="leg2"
				x="73.4389"
				y="216.683"
				width="1"
			...
			/>
			<rect
				style={{ display: getDisplayValue("arm1") }}
				id="arm1"
				x="1.20323"
				y="191.314"
				width="1"
			...
			/>
			<rect
				style={{ display: getDisplayValue("arm2") }}
				id="arm2"
				x="148.562"
				y="189.183"
				width="1"
			...
			/>
			<circle
				style={{ display: getDisplayValue("head") }}
				id="head"
				cx="74.2559"
				cy="88.5"
				r="30"
